<div class="product_area product_style2 mb-10">
    <div class="container">
                ...
                <div class="product_header">
                    ...
                    <div class="product_tab_btn">
                        <ul class="nav" role="tablist">
                            <li>
                                <a class="active" data-bs-toggle="tab" href="#bestseller-luggage" role="tab"
                                    aria-controls="bestseller-luggage" aria-selected="false">
                                    Luggage
                                </a>
                            </li>
                            <li>
                                <a data-bs-toggle="tab" href="#bestseller-backpacks" role="tab" aria-controls="bestseller-backpacks"
                                    aria-selected="false">
                                    Backpacks
                                </a>
                            </li>
                            <li>
                                <a data-bs-toggle="tab" href="#bestseller-bags" role="tab" aria-controls="bestseller-bags"
                                    aria-selected="true">
                                    Bags
                                </a>
                            </li>
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="bestseller-luggage" role="tabpanel">
                <div class="row">
            ...
            <div class="tab-pane fade" id="bestseller-backpacks" role="tabpanel">
                <div class="row">
                    <div class="product_carousel product_style product_column4 owl-carousel">
                        <div class="col-lg-3">
            ...
            <div class="tab-pane fade" id="bestseller-bags" role="tabpanel">
                <div class="row">
                    <div class="product_carousel product_style product_column4 owl-carousel">
                        <div class="col-lg-3">
                            <article class="single_product">
